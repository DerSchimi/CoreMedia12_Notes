# CM 12 (2406.3.0) Cheat Sheet
**Author:** Daniel Schimikowski
**Url:** https://github.com/DerSchimi/CoreMedia12_Notes/blob/main/cmcc-2406.3.0.cheatsheet.md
...
pnpm version 10.24.0 needed
```sh
pnpm i -g pnpm@10.24.0
```

Install node 24 (at least 24.11.1) and activate it via .zshrc
```sh
add export PATH="/opt/homebrew/opt/node@24/bin:$PATH" to .zshrc
&& restart zsh
```
